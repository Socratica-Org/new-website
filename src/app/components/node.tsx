...
export default function Node({
  ...
  return (
    <div id={id} className="flex flex-col">
      <div className="w-full text-left pl-2 pt-2">
      ...
      {lumaLink ? (
        <iframe
          title={name}
          src={lumaLink}
          className="w-[95%] md:w-[400px] h-[450px] md:h-[390px] rounded-lg mb-5 bg-[#F4F5F6] border-2 border-[#A09D98]"
          style={{ margin: "0 auto" }}
          aria-hidden="false"
        />
      ) : imageSrc ? (
        <Image
          ...
          width={400}
          height={350}
          className="w-full md:w-[400px] h-[500px] rounded-lg mb-5 bg-[#F4F5F6] border-2 border-[#A09D98]"
